...
--Calculate the most infected rate with Covid wrt Population
Select Location, MAX(total_cases) as MostTotalCases, population, MAX(total_cases/population)*100 as HighestInfectionRate
From ProjectPortfolio..CovidDeaths
--Where Location like '%India%'
